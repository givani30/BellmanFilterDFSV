"""
Unit tests for the Bellman Filter implementation in DFSV models.

This module provides tests to validate the Bellman filter implementation,
...
class TestBellmanFilter(unittest.TestCase):
    """Test suite for the DFSVBellmanFilter class."""
    ...
    def create_visual_comparison(self, save_path=None):
        ...
        try:
            ...
            smoothed_factors = bf.get_smoothed_factors()
            smoothed_log_vols = bf.get_smoothed_volatilities()
        ...
        fig.suptitle('Bellman Filter Performance: True vs. Filtered vs. Smoothed States', fontsize=16)
        plt.tight_layout()
