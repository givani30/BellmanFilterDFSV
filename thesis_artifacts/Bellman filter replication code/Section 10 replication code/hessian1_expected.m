function [output] = hessian1_expected(y_t_with_lags,h_t_with_lags,psi)
...
score_wrt_mu_y      = 0; % expectation of u_t / sigma_y;
hessian_wrt_mu_y    = -1 / sigma_y^2 ;

% First and second derivatives of observations density with respect to sigma_y
score_wrt_sigma_y   = 0; % expectation of ( u_t^2 - 1 ) / sigma_y;
hessian_wrt_sigma_y = - 2 / sigma_y^2 ; % expectation of ( 1 - 3 * u_t^2 ) / sigma_y^2;

% Cross derivative with respect mu_y and sigma_y
cross_hessian = 0; % expectation of - 2 * u_t / sigma_y^2;
