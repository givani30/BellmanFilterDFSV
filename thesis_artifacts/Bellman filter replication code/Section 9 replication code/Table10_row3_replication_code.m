...
hold on
xticks([0 10 20 30 40 50 60 70 80])
[p2]=plot(ML_parameters(:,5),'linewidth',2,'LineStyle',':','Color','k');
hold on
[p1]=plot(ML_parameters(:,4),'linewidth',2,'LineStyle','-','Color','k');
hold on
[p4]=plot(ML_parameters(:,7),'linewidth',2,'LineStyle','-.','Color','k');
hold on
[p3]=plot(ML_parameters(:,6),'linewidth',2,'LineStyle','--','Color','k');
hold on
