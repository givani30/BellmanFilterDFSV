...
ML_parameters  = zeros(t_final,5);
ML_parameters1 = zeros(t_final,5);
ML_parameters2 = zeros(t_final,5);
ML_parameters3 = zeros(t_final,5);
...
if t==1
    %starting_values = [0.103335952843112   0.035377257462019   0.541310849112810   1.636492246949862   6.985835894038097  -2.983296660495332];
    starting_values = [0.3   0.3   0.3   1.5 8];
else
...
ML_parameters(:,4) = abs(ML_parameters(:,4));
