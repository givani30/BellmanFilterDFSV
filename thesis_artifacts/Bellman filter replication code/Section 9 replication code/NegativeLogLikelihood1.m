function [NegativeLogL,LL1,LL2,LL3]=NegativeLogLikelihood1(parameter_vector,data,max_iterations)
...
[filtered_a,filtered_Info,predicted_a,predicted_Info] = Bellman_filter1(data,parameter_vector,max_iterations);
