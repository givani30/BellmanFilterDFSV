...
def test_run_optimization():
    ...
    for config in configs:
        ...
        try:
            ...
            print(
                f"  Lambda_r: True={true_params.lambda_r[0, 0]:.4f}, Estimated={result.final_params.lambda_r[0, 0]:.4f}"
            )
            print(
                f"  Phi_f: True={true_params.Phi_f[0, 0]:.4f}, Estimated={result.final_params.Phi_f[0, 0]:.4f}"
            )
            print(
                f"  Phi_h: True={true_params.Phi_h[0, 0]:.4f}, Estimated={result.final_params.Phi_h[0, 0]:.4f}"
            )
            print(
                f"  Mu: True={true_params.mu[0]:.4f}, Estimated={result.final_params.mu[0]:.4f}"
            )
            print(
                f"  Sigma2: True={true_params.sigma2[0]:.4f}, Estimated={result.final_params.sigma2[0]:.4f}"
            )
            print(
                f"  Q_h: True={true_params.Q_h[0, 0]:.4f}, Estimated={result.final_params.Q_h[0, 0]:.4f}"
            )
