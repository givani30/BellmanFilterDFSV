...
def multivariate_portmanteau_tests(
    residuals, lags=[5, 10, 15], df_model=0, max_dimension=30, random_state=None
):
    """
    ...
    if N > max_dimension:
        warnings.warn(
            f"Number of series ({N}) exceeds max_dimension ({max_dimension}). "
