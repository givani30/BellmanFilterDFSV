...
# Adjust the path relative to the conf.py file
# Goes up two levels (from docs/source to project root) then into src
...
extensions = [
    ...
    "sphinx.ext.intersphinx",  # Link to other projects' documentation (e.g., Python, NumPy, Jax)
]
